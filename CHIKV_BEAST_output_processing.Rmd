...
Trees with these many tips can be hard to read from the information on the tree tips simply due to space constraints: there's barely enough room to show all names on the page. You can use the geom_tiplab(size = 1.5) attribute to change the font size.
